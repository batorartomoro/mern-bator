...
export default function CreatePost() {
  ...
  return (
    <div className="p-3 max-w-3xl mx-auto min-h-screen">
        <h1 className="text-center text-3xl my-7 font-semibold">Buat Postingan</h1>
        <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
            ...
            <ReactQuill theme='snow' placeholder='Tulis sesuatu...' className='h-72 mb-12' required onChange={(value)=>{
