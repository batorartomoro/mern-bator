export default function TimCard({ tim }) {
  return (
    ...
    <div className="max-w-sm w-full lg:max-w-full lg:flex mx-auto my-10 mb-2 mt-2 ">
    <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
        <a href="#">
            <img className="h-48 lg:h-auto lg:w-48 flex-none bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden" src={tim.image} alt="Bonnie Avatar"></img>
        </a>
        <div className="p-5">
            <h3 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                <a href="#">{tim.nama}</a>
            </h3>
            <span className="text-gray-500 dark:text-gray-400">{tim.jabatan}</span>
            <p className="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400" dangerouslySetInnerHTML={{ __html: tim && tim.deskripsi }}></p>
